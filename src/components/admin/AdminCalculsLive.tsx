...
export default function AdminCalculsLive() {
  ...
  const calculatedCompetitors = useMemo(() => {
    ...
    // Auto-save is handled by the FirestoreSyncProvider
    // when hourly entries and big catches are saved
  ...
  const sectorTotals = useMemo((): SectorTotals => {
    return {
      ...
      poidsTotalGlobal: calculatedCompetitors.reduce((sum, comp) => sum + comp.poidsTotalGlobal, 0),
  ...
  const handleExportCSV = () => {
    ...
    a.href = url;
    a.download = `calculs-live-secteur-${activeSector}.csv`;
        ...
        <table className="w-full">
          <thead className="bg-gray-50 dark:bg-gray-800 sticky top-0 z-10">
            <tr>
              ...
              <th 
                className="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700"
                onClick={() => handleSort('poidsTotalGlobal')}
              >
                <div className="flex items-center space-x-1">
          ...
          <tbody className="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
            {filteredCompetitors.map(competitor => {
              ...
              return (
                ...
                >
                  ...
                  <td className="px-4 py-4 whitespace-nowrap text-center">
                    <span className="font-semibold text-gray-900 dark:text-gray-100">
                      {formatNumber(competitor.poidsTotalGlobal)}
                    </span>
                  </td>
                  ...
                  <td className="px-4 py-4 whitespace-nowrap text-center">
                    <div className="flex items-center justify-center space-x-1">
                      {competitor.nbPrisesGlobal === 0 && competitor.poidsTotalGlobal === 0 && competitor.grossePrise === 0 ? (
            ...
            <tr className="bg-gray-100 dark:bg-gray-800 border-t-2 border-gray-300 dark:border-gray-600">
              ...
              <td className="px-4 py-4 text-center">
                <span className="font-bold text-gray-900 dark:text-gray-100">
                  {formatNumber(sectorTotals.poidsTotalGlobal)}
                </span>
              </td>
              <td className="px-4 py-4 text-center">
                <span className="font-bold text-gray-900 dark:text-gray-100">
