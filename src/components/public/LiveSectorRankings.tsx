            ...
            <tbody>
              ${filteredCompetitors.map(comp => `
                <tr class="${comp.classementSecteur <= 3 ? `rank-${comp.classementSecteur}` : ''}">
                  ...
                  <td class="text-center">${formatNumber(comp.poidsTotalGlobal)}</td>
              ...
              <tr class="totals-row">
                ...
                <td class="text-center">${formatNumber(sectorTotals.poidsTotalGlobal)}</td>
            ...
            <div className="mt-6 grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg text-center">
                <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">
                  {formatWeight(sectorTotals.poidsTotalGlobal)}
                </div>
